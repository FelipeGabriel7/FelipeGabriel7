...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=26&duration=1500&pause=250&color=00FF88&center=true&vCenter=true&width=950&lines=Felipe+Gabriel;QA+%7C+SDET;Automation+%7C+Performance+%7C+DevOps" />
...
Atuo como **QA Engineer | SDET**, com foco em **automação de testes, confiabilidade e segurança**, trabalhando com sistemas **Web, Mobile, Desktop e APIs**, incluindo ambientes legados e modernização.

Tenho experiência com:
- Automação de testes **E2E e API**
- Testes de **performance ao longo do ciclo de desenvolvimento**
...
<details>
<summary><b>Testes (Web, API e Performance)</b></summary>
...
![Bruno](https://img.shields.io/badge/Bruno-0F172A?style=for-the-badge&logo=bruno&logoColor=white)
